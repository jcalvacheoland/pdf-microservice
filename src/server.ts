...
import pdfGeneratorDevelopment from "./routes/pdfGeneratorDevelopment";
import imageGeneratorDevelopment from "./routes/imageGeneratorDevelopment";
...
app.use(pdfGeneratorDevelopment);
app.use(imageGeneratorDevelopment);
